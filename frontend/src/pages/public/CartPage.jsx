...
function CartPage() {
  ...
  return (
    <Box sx={{ 
      ...
      <AppBar position="fixed" sx={{ bgcolor: '#3f51b5', color: 'white' }} elevation={1}>
        <Toolbar>
          <IconButton
            edge="start"
            color="inherit"
          ...
          <Typography variant="h6" component="div" sx={{ fontWeight: 600, color: 'white', flexGrow: 0, mr: 4 }}>
            Shopping Cart
          </Typography>
          ...
          {cartItems.length > 0 ? (
            <Grid container spacing={4}>
              <Grid item xs={12} md={8}>
                <Paper sx={{ p: 3, mb: { xs: 3, md: 0 }, bgcolor: '#f5f5f5' }}>
              ...
              <Grid item xs={12} md={4}>
                <Card elevation={3} sx={{ bgcolor: '#fafafa' }}>
                  <CardContent>
